                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="/DoAnWebCinema/admin/edit/employee/${user.maNV}/${tk.email}.htm">
                                    <div class="form-group mb-4">
                                     ...
                                     <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0"><b>Branch Staff</b></label>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
												...
												btn-success" style="background-color: #0083f7; color: #fff; height: 35px; border: none00; border: none; border-radius: 5px;">Update Profile</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
