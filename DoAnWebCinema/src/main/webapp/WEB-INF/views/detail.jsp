        ...
        <div class="movie-content">
            ...
            <div class="movie-info">
       			...
       			<c:when test="${phim.getDiem() == null}">
		            <span class="col_red me-3">Chưa có đánh giá nào từ khách hàng!</span>
		        </c:when>
            ...
            <div class="rating-container">
			    ...
			    <p id="rating-value" style="margin-left: 50px; margin-top: 30px;">
			        Điểm đánh giá của bạn: <span id="current-rating">${ratingScore}</span>
			    </p>
			</div>
			<form id="ratingForm" action="/DoAnWebCinema/film/detail/ma=${phim.getMaPhim()}.htm" method="POST">
			    ...
			    <button class="btn-send" id="btn-send" type="button">Gửi</button>
			</form>
            ...
            <div class="btn-row">
                ...
                <a class="button" id="dat-ve-link" href="#">Đặt vé ngay</a>
            </div>
        </div>
    </div>
<div id="successModal" class="modal">
  <div class="modal-content">
    ...
    <p style="color:black;">Đánh giá của bạn đã được lưu thành công!</p>
    <p style="color:black;">Cảm ơn bạn đã đánh giá phim!</p>
  </div>
</div>
<script>
