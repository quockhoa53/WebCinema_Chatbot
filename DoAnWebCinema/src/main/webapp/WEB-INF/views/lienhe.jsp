					...
					<div class="center_o1r text-end">
						<h6 class="mb-0 col_red">
							<a href="#">Trang chủ</a> <span class="me-2 ms-2 text-light"><i
								class="fa fa-caret-right align-middle"></i></span> Liên hệ
						</h6>
					</div>
				</div>
			</div>
			...
			<div class="row contact_1 bg_dark  pt-5 pb-5">
					...
					<div class="contact_1i row">
						...
						<div class="col-md-10 col-10">
							<div class="contact_1ir">
								<h5 class="col_red">Địa chỉ</h5>
								<p class="mb-0">97 Đ. Man Thiện, Hiệp Phú, Thủ Đức, Thành
									phố Hồ Chí Minh, Vietnam</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-3">
					<div class="contact_1i row">
						...
						<div class="col-md-10 col-10">
							<div class="contact_1ir">
								<h5 class="col_red">Giờ hoạt động</h5>
								<p class="mb-0">8:00 - 23:00</p>
								<p class="mb-0">Tất cả các ngày bao gồm cả Lễ Tết</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row contact_2 mt-4">
				<div class="col-md-3">
					<div class="contact_2r">
						<h5 class="mb-3">Trụ sở</h5>
						<p>
							<i class="fa fa-car col_red me-1"></i>97 Đ. Man Thiện, Hiệp Phú,
						...
						<h5 class="mb-3 mt-4">Giờ hành chính</h5>
						<p>
							Thứ 2 – Thứ 6: <span class="fw-bold text-white">8:00 -
								22:00</span>
						</p>
						<p>
							Thứ 7 : <span class="fw-bold text-white">8:00 to 13:00</span>
						</p>
						<p>
							Chủ nhật : <span class="fw-bold text-white">Đóng cửa</span>
						</p>
					</div>
				</div>
				<div class="col-md-9">
					...
					<div class="contact_2l1 mt-3 row">
						<div class="col-md-12">
							<div class="contact_2l1i">
								<textarea placeholder="Nội dung cần liên lạc"
