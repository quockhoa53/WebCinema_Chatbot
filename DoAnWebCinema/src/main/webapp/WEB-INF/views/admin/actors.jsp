        ...
        <div class="page-breadcrumb bg-white">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Diễn Viên</h4>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                            ...
                            <div>
                                <h3 class="box-title">Bảng diễn viên</h3>
                            </div>
                            <div class="btn-add-e">
                                <a href="#">
                            ...
                            <table class="table table-striped table-hover" id="sortTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-top-0">Tên Diễn viên</th>
                                        <th class="border-top-0">Ảnh</th>
                                        <th class="border-top-0">Các vai diễn</th>
								                ...
								                <c:choose>
								                    <c:when test="${not empty actors.anhDienVien}">
								                        <a href="/DoAnWebCinema/uploads/${actors.anhDienVien}" data-lightbox="actors-gallery" data-title="${actors.tenDienVien}">
								                            <img src="/DoAnWebCinema/uploads/${actors.anhDienVien}" alt="actors Image" width="50" height="50" class="img-thumbnail">
								                        </a>
								                    </c:when>
								                    <c:otherwise>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title">Thêm Diễn Viên Mới</h4>
                ...
                <form action="/DoAnWebCinema/admin/actors/add.htm" method="POST" enctype="multipart/form-data" modelAttribute="dienVien">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="info-box">
                                    <p class="label">Tên Diễn Viên</p>
                                    <input class="info-detail input-large" name="tenDienVien" required placeholder="Nhập tên diễn viên" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Danh sách Vai Diễn của Diễn Viên</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <table class="table">
                        ...
                        <tbody>
                            <!-- Duyệt qua danh sách vai diễn của diễn viên -->
    ...
    <div class="modal fade" id="e-${actors.getIdDienVien()}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header bg-primary text-white">
                    <h4 class="modal-title">Chỉnh Sửa Diễn Viên</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
                    <form action="/DoAnWebCinema/admin/actors/upload/${actors.getIdDienVien()}.htm" method="post" enctype="multipart/form-data" modelAttribute="dienvienUpdate">
                        ...
                        <!-- Submit Button -->
                        <div class="body-botton"  style="text-align: center;">
                            <button class="button-add">Cập Nhật</button>
                        </div>
                    </form>
                </div>
            </div>
