        ...
        <div class="page-breadcrumb bg-white">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Đạo Diễn</h4>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                            ...
                            <div>
                                <h3 class="box-title">Bảng đạo diễn</h3>
                            </div>
                            <div class="btn-add-e">
                                <a href="#">
                            ...
                            <table class="table table-striped table-hover" id="sortTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-top-0">Tên Đạo Diễn</th>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title">Thêm Đạo Diễn Mới</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="info-box">
                                    ...
                                    <input class="info-detail input-large" name="tenDaoDien" required placeholder="Nhập tên đạo diễn" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="e-${director.getIdDaoDien()}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header bg-primary text-white">
                    <h4 class="modal-title">Chỉnh Sửa Đạo Diễn</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
