    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title" id="myCenterModalLabel">Thêm Mới Phim</h4>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <button class="btn btn-outline-primary mb-3" style="margin:auto;">Mã Phim: <span>${p.maPhim}</span></button>
                                <p class="btn-f btn-solid-f">
                                    ${p.maTT == 1 ? "Đang chiếu" : p.maTT == 2 ? "Sắp chiếu" : "Ngừng chiếu"}
                                </p>
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="info-box">
                                            <p class="label">Ngày Khởi Chiếu</p>
                                            <h6 class="info-detail">
    ...
    <div class="modal fade" id="f-${p.maPhim}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header bg-primary text-white">
                    <h4 class="modal-title" id="myCenterModalLabel">Chỉnh Sửa Phim</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
