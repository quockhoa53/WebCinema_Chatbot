                                                            ...
                                                            <div class="body-full-fix">
                                                                ...
                                                                <div class="body-fix">
                                                                    <div class="body-right-fix">
                                                                        ...
                                                                        <div class="btn-fix">
                                                                            <button class="button-ma-fix">Thêm Ảnh</button>
                                                                        </div>
                                                                    ...
                                                                    <div class="body-left-fix">
                                                                        <div class="detail-info-fix">
                                                                            <p class="detail-info-top-fix">Họ Và Tên
                                                                            </p>
                                                                            <input
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <button class="btn btn-outline-primary mb-3">Mã khách hàng: ${s.maKH}</button>
                                <p class="status text-success">Hoạt Động</p>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="info-box">
                                            ...
                                            <h6 class="info-detail"><fmt:formatDate value="${s.ngaySinh}" pattern="dd-MM-yyyy"/></h6>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="info-box">
                                            ...
                                            <h6 class="info-detail">
                                                <c:choose>
                                                    <c:when test="${s.gioiTinh == false}">Nữ</c:when>
                                                    <c:when test="${s.gioiTinh == true}">Nam</c:when>
                                                </c:choose>
                                            </h6>
                                        </div>
                                    </div>
