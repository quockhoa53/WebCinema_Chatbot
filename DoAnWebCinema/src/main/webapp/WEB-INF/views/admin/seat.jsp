	...
	<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5"
		...
		<div class="page-wrapper" style="min-height: 250px;">
			...
			<div class="page-breadcrumb bg-white">
				<div class="row align-items-center">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Loại Ghế</h4>
					...
					<div class="col-sm-12">
						<div class="white-box">
							<div class="box-header">
								<div>
									<h3 class="box-title">Bảng Loại Ghế</h3>
								</div>
								<div class="btn-add-e">
									<a href="#">
								...
								<table class="table table-striped table-hover" id="sortTable">
									<thead>
										<tr>
											...
											<th class="border-top-0">Mã ghế</th>
											<th class="border-top-0">Tên loại ghế</th>
											<th class="border-top-0">Giá ghế</th>
												...
												<td>
												 <a href="#">
														<button class="button" data-bs-toggle="modal"
															data-bs-target="#t-${g.idLoaiGhe }">
															<i class="fa-solid fa-pen-to-square"></i>
														</button>
												</a>
												<a href="#">
															<button class="button" data-bs-toggle="modal"
															data-bs-target="#e-${g.idLoaiGhe }" >
			...
			<c:forEach var="g" items="${lg}">
			    	<div class="modal fade" id="e-${g.idLoaiGhe}" tabindex="-1" role="dialog"
							aria-hidden="true">
											...
											<div class="row tm-edit-product-row">
												<div class="col-12">
													<div class="header-add-e">
														<h3 class="header-name-add-e">Thêm Mới Loại Ghế</h3>
													</div>
													...
													<form class="container-add-e tm-edit-product-form"
														action="/DoAnWebCinema/admin/seat/add.htm"
														method="post" modelAttribute="seat">
														<div class="body-add-e">
															<!-- <div class="tieude1-add-e">
																<span class="chitiet-left-add-e">Mã Loại Ghế :</span>
																<div class="input-add-e">
																	<input type="text" name="idLoaiGhe" id=""
																		class="input-name-add-e" required>
																</div>
															</div> -->
															<div class="tieude1-add-e">
																<span class="chitiet-left-add-e">Tên Loại Ghế :</span>
																<div class="input-add-e">
			...
			<!-- Popup model add employee  -->
			<c:forEach var="g" items="${lg}" varStatus="status">
				<div class="modal fade" id="t-${g.idLoaiGhe }" tabindex="-1"
										...
										<div class="col-12">
											<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
												<div class="row tm-edit-product-row">
													<div class="col-12">
														<div class="header-add-e">
															<h3 class="header-name-add-e">Sửa Thông Tin Loại Ghế</h3>
														</div>
														...
														<form class="container-add-e tm-edit-product-form"
															action="/DoAnWebCinema/admin/seat/update/${g.idLoaiGhe }.htm"
															method="post" modelAttribute="seatUpdate">
															<div class="body-add-e">
																<div class="tieude1-add-e">
																	<span class="chitiet-left-add-e">Mã Loại Ghế:</span>
																	<div class="input-add-e">
																		<input type="text" name="idLoaiGhe"
																			class="input-name-add-e" value="${g.idLoaiGhe }" readonly />
																	</div>
																</div>
																<div class="tieude1-add-e">
																	<span class="chitiet-left-add-e">Tên Loại Ghế:</span>
																	<div class="input-add-e">
																		<input type="text" name="tenLoai"
																			class="input-name-add-e" value="${g.tenLoai }">
																	</div>
																</div>
																<div class="tieude1-add-e">
																	<span class="chitiet-left-add-e">Giá:</span>
																	<div class="input-add-e">
																		<input type="text" name="gia" id=""
																			class="input-name-add-e" value="${g.gia }" readonly>
																	</div>
																</div>
