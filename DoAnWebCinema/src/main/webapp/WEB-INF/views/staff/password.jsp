						...
						<div class="card-body">
                                                ...
                                                <form class="col-4 mx-auto pt-5 card" method="post" action="/DoAnWebCinema/admin/password.htm">
                                                        <div class="form-group col-md-12">
                                                            <label for="input-current-password"><b>Mật khẩu hiện tại</b></label>
                                                            <input type="password" name="oldPass" class="form-control"
                                                                id="input-current-password" required/>
                                                            ${message_o}
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="input-new-password"><b>Mật khẩu mới</b></label>
                                                            <input type="password" name="newPass" class="form-control"
                                                                id="input-new-password" required/>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="input-confirm-new-password"><b>Xác nhận mật khẩu mới</b></label>
