        ...
        <div class="info-film">
			<div class="info-film-container" style="display: flex; align-items: center; text-align: left;">
			    ...
			    <div class="detail-movie-poster" style="margin-left: 20px;">
			        ...
			        <h6 style="color: #fff;">Suất ${lc.formattedGioChieu} (${lc.ngayChieu})</h6>
			        <h6 style="color: red;">Rạp ${lc.getDsPhong().getChiNhanh().getTenChiNhanh()}</h6>
			    </div>
			</div>
            <br>
            <br>
            ...
            <br>
            <br>
            <p class="p-notify">Vui lòng chọn ghế trong sơ đồ ghế phía dưới. Ghế <b><i>Thường</i></b> có giá <b style="color: #6ac441; font-weight:200;">45000Đ</b> thường là 3 hàng ở đầu, các hàng tiếp theo bao gồm 2 ghế đầu và 2 ghế cuối. Ghế <b><i>Vip</i></b> có giá <b style="color: #6ac441; font-weight:200;">50000Đ</b> thường là các hàng tiếp sau 3 hàng đầu với các ghế có số từ 3 đến 8. Ghế <b><i>Đôi</i></b> có giá <b style="color: #6ac441; font-weight:200;">100000Đ</b> thường là hàng cuối cùng.</p>
			<div style="text-align: center; margin-top: 10px;">
			    <span style="display: inline-block; width: 15px; height: 15px; background-color: #6ac441; margin-right: 5px;"></span>
			    <span style="margin-right: 30px; color: white;">Ghế trống</span>
			    
			    <span style="display: inline-block; width: 15px; height: 15px; background-color: red; margin-right: 5px;"></span>
			    <span style="margin-right: 30px; color: white;">Ghế đã được mua</span>
			    
			    <span style="display: inline-block; width: 15px; height: 15px; background-color: #d3d3d3; margin-right: 5px;"></span>
			    <span style="color: white;">Ghế bạn đang chọn</span>
			</div>
            <br>
            ...
            <div id="reserveFooter" class="reserve-footer" style="display: none;">
				<c:if test="${phantramthaydoi > 0}">
				    <p>
				        <b style="color: #fff;">Bạn được giảm giá 
				            <i><fmt:formatNumber value="${(1 - phantramthaydoi) * 100}" pattern="#"/>%</i> 
				            của sự kiện <i>"${lydothaydoi}"</i>
				        </b>
				    </p>
				</c:if>		
                <p><b style="color: #fff;">Ghế đang chọn:</b> <span id="selectedSeatsDisplay">Chưa chọn ghế</span></p>
                <p><b style="color: #fff;">Tổng tiền cần thanh toán:</b> <span id="totalPrice">0 VNĐ</span></p>
				<form action="" method="POST">
				    <button type="submit" name="" class="btn-submit">Xác nhận</button>
				</form>
            </div>
        </div>
    </div>
