        ...
        <div class="confirm-panel">
            ...
            <div class="confirm-panel-content">
                <div class="panel-qrcode">
                    <span class="qrcode-label">Mã vào phòng:</span>
                    <div class="qr-image" id="qrcode"></div>
                </div>
				<div class="panel-info">
				    <div class="info-item"><b>Danh sách ghế:</b> <span>${ghe}</span></div>
				    <div class="info-item"><b>Rạp:</b> <span>${lc.getDsPhong().getChiNhanh().getTenChiNhanh()}</span></div>
				    <div class="info-item"><b>Phim:</b> <span>${lc.dsPhim.tenPhim}</span></div>
				    <div class="info-item"><b>Suất chiếu</b> <span>${lc.formattedGioChieu} (${lc.ngayChieu})</span></div>
				    <div class="info-item"><b>Tổng thanh toán:</b> <span>${tongTien}</span></div>
				</div>
            </div>
            <div class="edit-final">
                <form action="/DoAnWebCinema/customer/payment/${lc.maSC}.htm">
                    <button type="submit" class="btn btn-primary" id="btn-continue1">Đặt Tiếp</button>
                </form>
                <form action="/DoAnWebCinema/">
                    <button class="btn btn-secondary" type="submit">Trang Chủ</button>
                </form>
            </div>
        </div>
    </div>
