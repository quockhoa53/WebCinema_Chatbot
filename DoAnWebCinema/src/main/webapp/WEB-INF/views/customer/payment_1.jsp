        ...
        <div class="row" style="border-radius: 5px ;">
          <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
              ...
              <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                  <h6 class="my-0">Danh sách ghế</h6>
              ...
              <li class="list-group-item d-flex justify-content-between bg-light">
                <div class="text-success">
                  ...
                  <small>Suất ${lc.formattedGioChieu} (${lc.ngayChieu })</small>
                </div>
				<li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                  <h6 class="my-0">Rạp</h6>
              ...
              <div>
					...
					<h6 class="my-0">Giảm giá: <fmt:formatNumber value="${(1 - phantramthaydoi) * 100}" pattern="#"/>%</h6>
				  </c:if>
                  <c:if test="${lydothaydoi} != null">
						<small class="text-muted">Sự kiện ${lydothaydoi}</small>
				  </c:if>
              </div>
              </li>
             ...
             <div id="countdown-timer" style="font-weight: bold; color: red; text-align: center; margin-bottom: 10px;">
			  <!-- Thời gian giữ ghế sẽ được hiển thị tại đây -->Thời gian giữ ghế: 05:00
			</div>
          </div>
             ...
             <div class="btn-trangthai" style="margin-left:190px; display: flex;">
				...
				<form id="paymentForm" action="/DoAnWebCinema/customer/payment_2/${lc.maSC}/${ghe}.htm">
				    <button type="submit" class="btn btn-primary btn-lg btn-block" id="btn-continue1"
				        style="background:#5eb742; color: #fff; border: none; margin-left: 5px; cursor: pointer">Thanh Toán
				    </button>
				</form>
              </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="color: black;">Hết thời gian đặt ghế!</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="redirectToPayment(${lc.maSC})">Đặt lại vé</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function startCountdown(duration) {
        ...
        const interval = setInterval(() => {
            ...
            countdownElement.textContent = "Thời gian giữ ghế: " + minutes + ":" + seconds;
